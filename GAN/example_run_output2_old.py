...
if 1:
	## first nn: test 4
	os.system(
		'python multipassGAN-4x.py randSeed 174213111 upRes 4 startIndex 0 out 1 pretrain 0 pretrainDisc 0 '
		'tileSize 32 lambda 5.0 lambda2 0.00001 discRuns 2 genRuns 2 alwaysSave 1 '
		'fromSim 1000 toSim 1000 outputInterval 200 genTestImg 1 dropout 0.5 dataDim 3 batchSize 16 '
		...
		'lambda_t_l2 0.0 frame_min 110 frame_max 110 data_fraction 0.01 adv_flag 1 dataAugmentation 1 '
	...
	# os.system(
	# 	'python multipassGAN-4x.py randSeed 174213111 upRes 4 startIndex 0 out 1 pretrain 0 pretrainDisc 0 '
	# 	'tileSize 64 lambda 5.0 lambda2 0.00001 discRuns 2 genRuns 2 alwaysSave 1 '
	# 	'fromSim 0000 toSim 0008 outputInterval 200 genTestImg 1 dropout 0.5 dataDim 3 batchSize 16 '
	# 	'useVelocities 1 useVorticities 0 useK_Eps_Turb 0 useFlags 0 gif 0 genModel gen_resnet '
	# 	f'discModel disc_binclass basePath {basepath} packedSimPath {packedpath} lambda_t 1.0 '
	# 	'lambda_t_l2 0.0 frame_min 1100 frame_max 1101 data_fraction 0.01 adv_flag 1 dataAugmentation 1 '

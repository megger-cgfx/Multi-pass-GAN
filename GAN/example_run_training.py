...
os.system('python multipassGAN-8x.py randSeed 16131119 upRes 8 use_res_net 1 batchNorm 0 pixelNorm 1 out 0 pretrain 0 '
          ...
          'discModel disc_binclass basePath ../2ddata/ packedSimPath ../data3d_growing/ lambda_t 1.0 lambda_t_l2 0.0 '
...
os.system('python multipassGAN-8x.py randSeed 9631119 upRes 8 use_res_net 1 batchNorm 0 pixelNorm 1 out 0 pretrain 0 '
          ...
          'useVelocities 1 useVorticities 0 useK_Eps_Turb 0 useFlags 0 gif 0 genModel gen_resnet '
          'discModel disc_binclass basePath ../2ddata/ packedSimPath ../data3d_growing/ lambda_t 1.0 '

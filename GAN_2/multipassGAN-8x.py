...
if upsampled_data:
	...
	if upsampling_mode == 1:
		lowfilename_2 = "density_low_t%04d_2x2" % (outNNTestNo) + "_%04d.npz"
	elif upsampling_mode == 0:
	    lowfilename_2 = "density_low_t%04d_2x2x1" % (outNNTestNo) + "_%04d.npz"
	elif upsampling_mode == 3:
	    lowfilename_2 = "density_low_t%04d_1x1" % (outNNTestNo) + "_%04d.npz"
else:
...
if ((not useTempoD) and (not useTempoL2)): # should use the full sequence, not use multi_files
	...
	if currentUpres == upRes:
		...
		currentHighFileName = "density_low_%i"%(currentUpres)+"_%04d.npz"
